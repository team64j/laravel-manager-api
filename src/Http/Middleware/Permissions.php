...
class Permissions
{
    ...
    protected array $permission = [
        ...
        'manager.api.document.destroy' => ['delete_document'],
        'manager.api.document.index' => ['edit_document', 'view_document'],
        'manager.api.document.parents' => ['view_document'],
        'manager.api.document.set-parent' => ['view_document'],
        'manager.api.document.show' => ['view_document'],
        'manager.api.document.store' => ['new_document'],
        'manager.api.document.tree' => ['view_document'],
        'manager.api.document.update' => ['save_document'],

        'manager.api.documents' => ['view_document'],
