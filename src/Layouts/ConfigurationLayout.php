            ...
            Panel::make()
                ...
                ->setData([
                    [
                        ...
                        'key' => 'site_name',
                        'value' => Input::make()->setModel('site_name'),
                    ],
                    [
                        'name' => __('global.sitestatus_title'),
                        'key' => 'site_status',
                        'value' => Select::make()->setModel('site_status')
                            ->addYesNo(
                                __('global.online'),
                                __('global.offline')
                            ),
                    ...
                    [
                        ...
                        'value' => Select::make()->setModel('auto_template_logic')
                            ->setData($auto_template_logic_values),
                    ],
                    [
                        'name' => __('global.chunk_processor'),
                        'key' => 'chunk_processor',
                        'value' => Select::make()->setModel('chunk_processor')
                    ...
                    [
                        ...
                        'key' => 'enable_cache',
                        'value' => Select::make()->setModel('enable_cache')
                    ...
                    [
                        ...
                        'value' => Select::make()->setModel('disable_chunk_cache')->addYesNo(),
                    ],
                    [
                        'name' => __('global.disable_snippet_cache_title'),
                        'key' => 'disable_snippet_cache',
                        'value' => Select::make()->setModel('disable_snippet_cache')->addYesNo(),
                    ],
                    [
                        'name' => __('global.disable_plugins_cache_title'),
                        'key' => 'disable_plugins_cache',
                        'value' => Select::make()->setModel('disable_plugins_cache')->addYesNo(),
                    ],
                    [
                        'name' => __('global.cache_type_title'),
                        'key' => 'cache_type',
                        'value' => Select::make()->setModel('cache_type')
                    ...
                    [
                        ...
                        'value' => Select::make()->setModel('minifyphp_incache')
                            ->addYesNo(
                                __('global.enabled'),
                                __('global.disabled')
                            ),
                    ...
                    [
                        ...
                        'value' => Select::make()->setModel('server_offset_time')->setData($serverTimes),
                    ],
                    [
                        'name' => __('global.server_protocol_title'),
                        'name.help' => __('global.server_protocol_message'),
                        'key' => 'server_protocol',
                        'value' => Select::make()->setModel('server_protocol')
            ...
            Panel::make()
                ...
                ->setData([
                    ...
                    [
                        ...
                        'value' => Select::make()->setModel('allow_duplicate_alias')->addYesNo(),
                    ],
                    [
                        'name' => __('global.automatic_alias_title'),
                        'name.help' => __('global.automatic_alias_message'),
                        'key' => 'automatic_alias',
                        'value' => Select::make()->setModel('automatic_alias')->addYesNo(),
                    ],
                ]),
        ];
    }
            ...
            Panel::make()
                ...
                ->setData([
                    ...
                    [
                        ...
                        'key' => 'login_logo',
                        'value' => \Team64j\LaravelManagerComponents\File::make()
                            ->setModel('login_logo')
                    ...
                    [
                        ...
                        'value' => Select::make()
                            ->setModel('manager_menu_position')
                            ->setData([
                                [
                                    'key' => 'top',
                    ...
                    [
                        ...
                        'key' => 'show_picker',
                        'value' => Select::make()->setModel('show_picker')->addYesNo(),
                    ],
                    [
                    ...
                    [
                        ...
                        'value' => Select::make()->setModel('show_newresource_btn')->addYesNo(),
                    ],
                    [
                        'name' => __('global.show_fullscreen_btn'),
                        'name.help' => __('global.show_fullscreen_btn_message'),
                        'key' => 'show_fullscreen_btn',
                        'value' => Select::make()->setModel('show_fullscreen_btn')->addYesNo(),
                    ],
                    [
                        ...
                        'value' => Select::make()
                            ->setModel('resource_tree_node_name')
                            ->setData([
                                [
                                    'key' => 'pagetitle',
                                    'value' => '[*pagetitle*]',
            ...
            Panel::make()
                ...
                ->setData([
                    [
                        ...
                        'key' => 'use_udperms',
                        'value' => Select::make()->setModel('use_udperms')->addYesNo(),
                    ],
                    [
                    ...
                    [
                        ...
                        'value' => Input::make()->setModel('safe_functions_at_eval'),
                    ],
                    [
                        'name' => __('global.check_files_onlogin_title'),
                        'name.help' => '',
                        'key' => 'check_files_onlogin',
                        'value' => Textarea::make()->setModel('check_files_onlogin'),
                    ],
                    [
                        'name' => __('global.validate_referer_title'),
                        'name.help' => '',
                        'key' => 'validate_referer',
                        'value' => Select::make()->setModel('validate_referer')->addYesNo(),
                    ],
                    [
                    ...
                    [
                        ...
                        'key' => 'use_captcha',
                        'value' => Select::make()->setModel('use_captcha')->addYesNo(),
                    ],
                    [
                        'name' => __('global.check_files_onlogin_title'),
                        'name.help' => __('global.captcha_words_message'),
                        'key' => 'captcha_words',
                        'value' => Textarea::make()->setModel('captcha_words'),
                    ],
                ]),
        ];
    }
            ...
            Panel::make()
                ...
                ->setData([
                    [
                        ...
                        'key' => 'use_browser',
                        'value' => Select::make()->setModel('use_browser')->addYesNo(),
                    ],
                    [
            ...
            Panel::make()
                ...
                ->setData([
                    [
                        ...
                        'key' => 'emailsender',
                        'value' => Input::make()->setModel('emailsender'),
                    ],
                    [
                    ...
                    [
                        ...
                        'name.help' => '',
                        'key' => 'smtp_auth',
                        'value' => Select::make()->setModel('smtp_auth')->addYesNo(),
                    ],
                    [
                        'name' => __('global.smtp_autotls_title'),
                        'name.help' => '',
                        'key' => 'smtp_autotls',
                        'value' => Select::make()->setModel('smtp_autotls')->addYesNo(),
                    ],
                    [
